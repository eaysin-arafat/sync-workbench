...
const IdentityVerification = () => {
  ...
  return (
    <div>
      <div>
        <h1 className="text-xl font-semibold pb-6">Passport Verification</h1>
      ...
      <div>
        <h1 className="text-xl font-semibold pb-6">PAN Verification</h1>
      ...
      <div>
        <h1 className="text-xl font-semibold pb-6">Aadhar Verification</h1>
